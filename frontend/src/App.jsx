  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        {route.name === "upload" && <Upload onCreated={(c) => go("case", c)} />}
        {route.name === "dashboard" && <Dashboard onOpenCase={(id)=>go("case", id)} />}
        {route.name === "case" && <CaseDetails caseId={route.payload} onBack={() => go("dashboard")} />}
      </div>
